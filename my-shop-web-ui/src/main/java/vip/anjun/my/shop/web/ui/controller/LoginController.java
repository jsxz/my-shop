package vip.anjun.my.shop.web.ui.controller;

import vip.anjun.my.shop.commons.dto.BaseResult;
import vip.anjun.my.shop.commons.utils.EmailSendUtils;
import vip.anjun.my.shop.web.ui.api.UsersApi;
import vip.anjun.my.shop.web.ui.constant.SystemConstants;
import vip.anjun.my.shop.web.ui.dto.TbUser;
...
public class LoginController {
    ...
    public String login(TbUser tbUser, Model model, HttpServletRequest request) throws Exception {
        ...
        // 登录成功
            ...
            emailSendUtils.send("用户登录", String.format("用户 【%s】 登录 MyShop", user.getUsername()), "anjun@yeah.net");
            // 将会员信息放入 Session
